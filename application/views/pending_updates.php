		<div class="row">
			<div class="col-md-12">
				...
				<a href="<?php echo site_url('review/pending_updates'); ?>" class="btn btn-default"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Updates <span class="badge"><?php echo $counts['updates']; ?></span></a>
		...
		<h2>There are no pending updates to links.</h2>
		<?php endif; ?>
